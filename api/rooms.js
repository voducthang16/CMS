...
router.get('/subject/:name/:link', function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var name, link, rowName, rowLink;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    name = req.params.name;
                    link = req.params.link;
                    return [4 /*yield*/, Rooms.count({ name: name })];
                case 1:
                    rowName = _a.sent();
                    return [4 /*yield*/, Rooms.count({ link: link })];
                case 2:
                    rowLink = _a.sent();
                    res.send({
                        rowName: rowName,
